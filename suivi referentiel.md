...
| Module | Compétences |
|:-------------|:------------|
| Traiter un incident dans un centre de services et assurer le suivi du parc{.fait} | Traiter un ticket d'incident à l’aide d’un outil de gestion (saisir le ticket, qualifier l'incident, décider de la suite à donner et clôturer le ticket). 
